 ...
 * @date 05/29/21
 * @file 
 * @details Реализация методов и конструктора описанных в chipping.h
 */
/// Реализация методов и конструктора описаных в chipping.h
/// Конструктор класса @throw std::wstring(L"Not allowd format key")
 ...
 * @return wstring chiperedMessage
